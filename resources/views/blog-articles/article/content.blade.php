@extends('blog-articles.article.layout.app')
...
@section('content')
    <div class="wrapper">
        ...
        @include('blog-articles.article.header')
        <main>
                            ...
                            <div class = 'rate-banner'>
                                ...
                                <div class = 'bottom-banner'>
                                    <div class = 'rate'>
                                        ...
                                        <input type="hidden" id="article-id" value="{{$getArticleById['id']}}">
            ...
            @if(!empty($getArticleById['related_articles']))
        <div class = 'main-bottom'>
            <div class = 'container'>
                <div class = 'related-articles'>
                    <ul>
                        @foreach($getArticleById['related_articles'] as $value)
                        <li><a href = '{{$value['Link']}}'> {{$value['Title']}} <div class = 'related-link-arrow'></div></a></li>
                        @endforeach
                    </ul>
        ...
        <div class = 'container'>
            <div class = 'peopole-reviews' id="article-comments">
                ...
                <div class = 'load-button load-another-people-reviews'>
                    <button class = 'gray-btn' id="load-more-article"><span id="load-more-article-button">Read more reviews</span>
                ...
                @endif
        @include('blog-articles.article.comment-form')
            
        </main>
        </div>
        @include('blog-articles.article.footer')
    </div>
@endsection