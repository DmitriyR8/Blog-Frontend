            ...
            <form id = 'comment-form' name = 'comment-form' validate>
                ...
                <div class = 'header-comment'>
                    ...
                    <div class = 'header-comment_input_wrapper_email'>
                        <input type = 'email' id="email" pattern="([a-z0-9]+[._-]){0,}?[a-z0-9]+@[a-z0-9]+[.]{1}[a-z]{2,4}$" title = "username@some.ca" placeholder = "Enter your actual email" required>
                ...
                <input type="hidden" id="type" value="blog-article">
                <input type="hidden" id="comment-type" value="App\BlogArticle">
                <input type="hidden" id="comment-id" value="{{$getArticleById['id']}}">
            </form>
