...
<head>
    ...
    <meta name="description" content="{{ preg_replace('/<[^>]*>/', '', $getArticleById['description'] )}}">
    <title>{{$getArticleById['title']}}</title>
    ...
    <link rel = "stylesheet" href = "{{asset('css/single-article.css')}}">
...
<body>
    ...
    <script src="{{asset('js/LoadMoreArticleComments.js')}}"></script>
