        ...
        <header>
            ...
            <div class = 'header-bottom'>
                <picture>
                    <source srcset = "{{asset(env('APP_URL').'image/samuel-zeller-4138-unsplash.webp')}}" type="image/webp">
                    <source srcset = "{{asset(env('APP_URL').'image/samuel-zeller-4138-unsplash.png')}}" type="image/png">
                    <img src = "{{asset(env('APP_URL').'image/samuel-zeller-4138-unsplash.png')}}">
                </picture>
                <div class = 'headline'>
                    <h1>
                        Zilliqa based on some hot hardware wallet, and since Golem is wary of many provably deterministic wallet of many double!
                    </h1>
                </div>
            </div>
        </header>
