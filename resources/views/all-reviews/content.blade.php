...
@section('content')
    <div class="wrapper">
        ...
        <main>
            ...
            <div class = 'container'>
                <div class = 'underline header-bottom-underline'>
                    <div>
                        <span class = "filter {{$allReviews['filter'] == null ? 'active-filter-reviews' : null}}"><a href = 'single-reviews'>All review</a></span>
                        <span>|</span>
                        <span class = "filter {{$allReviews['filter'] == 'negative' ? 'active-filter-reviews' : null}}"><a href = 'single-reviews?filter=negative'>Negative review</a></span>
                        <span>|</span>
                        <span class = "filter {{$allReviews['filter'] == 'recommended' ? 'active-filter-reviews' : null}}"><a href = 'single-reviews?filter=recommended'>Recommended review</a></span>
                    </div>
                    <span>{{$allReviews['data']['total']}} reviews</span>
                </div>
                <div class = 'reviews-wrapper' id="all">
                    <div class = 'left-arrow'></div>
                    @foreach($allReviews['data']['data'] as $value)
                        <div class = 'single-review'>
                            ...
                            <div class = 'single-review-info'>
                                ...
                                <p>
                                    ...
                                    <input type="hidden" id="filter" value="{{$allReviews['filter']}}">
                                </p>
